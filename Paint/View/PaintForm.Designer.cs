namespace Paint {
  partial class PaintForm {
    ...
    private void InitializeComponent() {
      ...
      this.gradientStyleCombo = new System.Windows.Forms.ComboBox();
      ...
      this.toolSettingsPanel.SuspendLayout();
      ...
      // toolSettingsPanel
      // 
      this.toolSettingsPanel.Controls.Add(this.brushImageBox);
      this.toolSettingsPanel.Controls.Add(this.label6);
      this.toolSettingsPanel.Controls.Add(this.label5);
      this.toolSettingsPanel.Controls.Add(this.lineStyleCombo);
      this.toolSettingsPanel.Controls.Add(this.inverseLink);
      this.toolSettingsPanel.Controls.Add(this.primColorBox);
      this.toolSettingsPanel.Controls.Add(this.secColorBox);
      this.toolSettingsPanel.Controls.Add(this.label4);
      this.toolSettingsPanel.Controls.Add(this.label3);
      this.toolSettingsPanel.Controls.Add(this.label2);
      this.toolSettingsPanel.Controls.Add(this.label1);
      this.toolSettingsPanel.Controls.Add(this.gradientStyleCombo);
      this.toolSettingsPanel.Controls.Add(this.widthCombo);
      this.toolSettingsPanel.Controls.Add(this.shapeStyleCombo);
      this.toolSettingsPanel.Controls.Add(this.fillStyleCombo);
      this.toolSettingsPanel.Dock = System.Windows.Forms.DockStyle.Top;
      this.toolSettingsPanel.Location = new System.Drawing.Point(0, 0);
      this.toolSettingsPanel.Name = "toolSettingsPanel";
      this.toolSettingsPanel.Size = new System.Drawing.Size(739, 61);
      this.toolSettingsPanel.TabIndex = 4;
      // 
      // brushImageBox
      // 
      ...
      // gradientStyleCombo
      // 
      this.gradientStyleCombo.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
      this.gradientStyleCombo.FormattingEnabled = true;
      this.gradientStyleCombo.Location = new System.Drawing.Point(460, 4);
      this.gradientStyleCombo.Name = "gradientStyleCombo";
      this.gradientStyleCombo.Size = new System.Drawing.Size(121, 21);
      this.gradientStyleCombo.TabIndex = 3;
      // 
      // widthCombo
      // 
      ...
      this.Controls.Add(this.toolSettingsPanel);
    ...
    private System.Windows.Forms.Panel toolSettingsPanel;
    private System.Windows.Forms.ComboBox gradientStyleCombo;
